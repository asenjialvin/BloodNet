...
export async function createUser(email, password, username) {
  try {
    // Authenticate the user before creating a new account
    const session = await signIn(email, password);

    const account = new Account(client, appwriteConfig.endpoint, appwriteConfig.projectId);
